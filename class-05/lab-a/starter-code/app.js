...
function sum(a, b) { //eslint-disable-linent-disable-line
    var theSum = a + b;
...
function multiplyArray(multArr) { //eslint-disable-line
  var newProduct = multiply(multArr[0], multArr[1])[0];
  newProduct = multiply(newProduct, multArr[2])[0];
  console.log(newProduct);
  return [newProduct, 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + newProduct + '.']
